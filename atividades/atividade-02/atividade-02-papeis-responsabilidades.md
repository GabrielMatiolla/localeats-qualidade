...
| Thiago Figueiredo | QA | Planejar e executar testes, identificar e registrar defeitos, verificar se as funcionalidades atendem aos requisitos e critérios de aceitação, acompanhar a correção dos defeitos e comunicar os resultados dos testes à equipe | Conhecimento em técnicas e tipos de teste de software, elaboração de casos de teste, identificação e análise de riscos, testes funcionais e uso de ferramentas de gerenciamento de defeitos | Atenção aos detalhes, pensamento crítico, organização, comunicação clara, responsabilidade e colaboração com desenvolvedores e demais integrantes da equipe |
...
| Validação Conjunta | Funcionalidades chegando à etapa de testes formais ou aos usuários com defeitos muito básicos. | Desenvolvedor e QA. |
